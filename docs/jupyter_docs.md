...
Este repositorio contiene los documentos para la implementación de las simulaciones de robots seriales.

Archivos:

- Conceptos_basicos.ipynb
- Robotica_serial_control.ipynb
- Nodos_y_Topicos.ipynb
- Sensores_basicos.ipynb

El material audiovisual relacionado se puede consultar en:
